...
### Added
- Grant reviewer path (`/reviewer`) with stepper, checklist, trust strip
...
- Docs: SCREENSHOTS checklist, updated BENCHMARK_RESULTS, BETA outreach

### Changed
- All demo CTAs route to bundled sample reports (not disabled `/scan` form)
- Per-page SEO metadata on all grant-path routes
- Footer + application materials updated for grant submission
