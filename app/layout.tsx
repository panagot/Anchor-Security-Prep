...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og.svg", width: 1200, height: 630, alt: "Anchor Security Prep — 41 vs 0 high/critical demo" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Anchor Security Prep",
    description: "Pre-audit static analysis for Anchor programs — 26 rules, SARIF, MIT",
    images: ["/og.svg"],
  },
  icons: {
